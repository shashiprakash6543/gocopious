...
WebUI.click(findTestObject('Object Repository/HRIS/dashboard_menu/Page_My Dashboard  TrilaSoft/a_1'))

String title = WebUI.getText(findTestObject('Object Repository/HRIS/Page_Documents  TrilaSoft/h3'))
println(title)

assert title == "Documents"
WebUI.closeBrowser()